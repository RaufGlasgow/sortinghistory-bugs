...
function extractFormatSpecifiers(value) {
...
function isValidSwiftDictEntry(key, value) {
    ...
    if (unescapedQuoteInKey || unescapedQuoteInValue)
        return false;
 ...
 */
export function runT0StructuralCheck(translatedEvent, englishEvent) {
...
export function countDiacritics(text) {
 ...
 */
export function runT9DiacriticsCheck(translatedEvent, language) {
 ...
 */
export function isLikelyUntranslated(translatedEvent, englishEvent, whitelist = CROSS_LANGUAGE_WHITELIST) {
 ...
 */
export function validatePortugueseDiacritics(text, baselineDensity) {
 ...
 */
export function runTranslationAutomatedChecks(translatedEvents, englishEvents, language) {
 ...
 */
export function verifyTranslations(input) {
    const findings = [];
