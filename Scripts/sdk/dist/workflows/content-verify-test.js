...
export async function runContentVerifyTest() {
    ...
    for (const planted of PLANTED_ERRORS) {
        ...
        if (flagged) {
            ...
            const expectedCodeMatched = planted.expectedGateCodes.some(ec => codes.some(c => c === ec || c.startsWith(ec.charAt(0))));
