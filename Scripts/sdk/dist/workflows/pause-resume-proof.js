 ...
 */
export async function runPausePhase1() {
    ...
    let finding;
    try {
        const parsed = JSON.parse(extractJson(result.responseText));
 ...
 */
export async function runResumePhase2(workflowId) {
    ...
    if (recalledTitle === originalFinding.event_title &&
 ...
 */
export async function runPauseResumeProof() {
