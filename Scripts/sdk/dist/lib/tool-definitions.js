...
const TOOL_DEFS = {
    Read: {
        ...
        function: {
            name: "Read",
            description: "Reads a file from the filesystem. Returns the file contents as a string. " +
    ...
    Edit: {
        ...
        function: {
            name: "Edit",
            description: "Performs an exact string replacement in a file. Finds old_string and replaces " +
    ...
    Glob: {
        ...
        function: {
            name: "Glob",
            description: "Finds files matching a glob pattern. Returns matching file paths, one per line.",
            parameters: {
                type: "object",
                properties: {
                    pattern: {
    ...
    Grep: {
        ...
        function: {
            name: "Grep",
            description: "Searches file contents using a regex pattern (via ripgrep). " +
