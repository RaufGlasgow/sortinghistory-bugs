...
import { validateFix, parseDiffFiles, extractLangLabel, extractBugType, } from "../lib/validate-fix.js";
/**
...
describe("parseDiffFiles", () => {
    it("extracts file paths from git diff headers", () => {
        const diff = "diff --git a/Data/en/USHistory.json b/Data/en/USHistory.json\n" +
