...
import { saveSession, getSession, removeSession, completeSession, listPausedSessions, } from "../lib/session.js";
...
beforeEach(() => {
    ...
    PATHS.SESSION_REGISTRY = path.join(tempDir, "sessions.json");
});
afterEach(() => {
    PATHS.SESSION_REGISTRY = originalRegistry;
...
describe("saveSession", () => {
    ...
    it("saves session with correct schema matching Architecture Section 4.3", async () => {
        ...
        const parsed = new Date(entry.paused_at);
