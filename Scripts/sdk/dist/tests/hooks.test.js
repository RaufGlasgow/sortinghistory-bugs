...
import { createToolRestrictionHook, createJsonValidationHook, buildHooksConfig, } from "../lib/hooks.js";
/** Minimal PreToolUse input factory matching SDK BaseHookInput + PreToolUseHookInput */
function makePreToolInput(toolName, filePath) {
    return {
...
function makePostToolInput(toolName, filePath) {
    return {
        session_id: "test-session",
        transcript_path: "/tmp/test-transcript",
        cwd: "/tmp",
