...
import { shouldSendEmail, sendActionNeededEmail, sendPRCreatedEmail, sendHandoffEmail, buildEmailHtml, buildPRCreatedEmailHtml, buildHandoffEmailHtml, } from "../lib/notification.js";
// ---------------------------------------------------------------------------
...
- App Version: 1.1.0-alpha.261`;
        ...
        assert.ok(html.includes("bug-webhook.emptycupmedia.workers.dev/screenshots/abc123.png"), "Screenshot R2 URL was stripped — should be preserved");
...
- App Version: 1.1.0-alpha.265`;
        ...
        assert.ok(html.includes("bug-webhook.emptycupmedia.workers.dev/screenshots/long-test.png"), "Screenshot URL was truncated — screenshots must NEVER be truncated");
        ...
        assert.ok(html.includes("Full details available via Fix Locally"), "Truncation notice with Fix Locally link missing");
    });
});
