...
export const WORKFLOW_BACKENDS = {
    bug_fix: "local",
    bug_triage: "claude",
    triage: "claude",
    qa_review: "claude",
...
export const ALWAYS_HANDOFF_CLASSIFICATIONS = [
    "crash_bug",
    "purchase_error",
];
/** Read-only tools for verifier subagents */
export const VERIFIER_TOOLS = ["Read", "Glob", "Grep", "Bash"];
/** Minimal tools for proof workflow — truly read-only, no Bash */
export const PROOF_TOOLS = ["Read", "Glob", "Grep"];
...
export const CLASSIFICATION_SET = new Set(CLASSIFICATIONS);
