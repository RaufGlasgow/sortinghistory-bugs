...
import { TRIAGE_FIXTURES, type TriageFixture } from "./triage-fixtures.js";
...
interface DryRunSummary {
  ...
  accuracy: number;
  errors: FixtureError[];
  misclassifications: FixtureResult[];
  cost_usd: number;
}
...
function isCorrect(got: string, expected: string | string[]): boolean {
...
function parseFixtureFlag(): string | null {
