...
function checkRoutingCases(repoRoot: string): string[] {
...
function checkRoutingFixtures(): string[] {
...
function checkPromptHeadings(repoRoot: string): string[] {
...
function checkTriageValidator(repoRoot: string): string[] {
...
export function runContractTest(): void {
